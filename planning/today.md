...
### Task A — Repo URL fill-ins (placeholder)
...
### Task B — Final review pass (placeholder)
...
### Task C — Initial GitHub push (placeholder)
...
- [ ] Suite regression at clean baseline post-Task-A (only commit-tracked changes can affect suite; Day 12 expected to land 0 wiring-test deltas)
- [ ] DECISIONS bundled entry written if any design decisions land during Day 12 (per Day 7 pattern)
...
>
> Three-task placeholder structure (alignment session ratifies / refines):
>
> - **Task A** = Repo URL fill-ins (`pyproject.toml [project.urls]`, README clone command, content drafts at `planning/scratch/day-11-launch-content/` — note: drafts are operator-side updates to working artifacts, NOT commit-tracked changes per D5 durable principle)
> - **Task B** = Final review pass across README / ABOUT / LICENSE / CHANGELOG / CONTRIBUTING / pyproject.toml metadata for any drift caught during Days 9-11
> - **Task C** = Initial GitHub push (remote setup, branch protection, Issues enablement, public-visibility verification)
>
> Effort: max throughout. Public-launch day; review quality and push hygiene matter.
>
...
> - Read-after-edit for structural config files (candidate, Day 9; multiple Day-10/Day-11 data points): edit-success ≠ semantic correctness; applies to TOML / YAML / Markdown structural edits at Task A entry
